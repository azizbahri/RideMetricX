  ...
  group('Windows Build Configuration', () {
    ...
    test('Windows runner CMakeLists.txt exists', () {
      ...
      expect(runnerCmakeFile.existsSync(), isTrue,
          reason:
              'windows/runner/CMakeLists.txt must exist for Windows builds');
    });
    ...
    test('Windows flutter CMakeLists.txt exists', () {
      ...
      expect(flutterCmakeFile.existsSync(), isTrue,
          reason:
              'windows/flutter/CMakeLists.txt must exist for Windows builds');
    });
    ...
    test('Windows CMakeLists.txt defines apply_standard_settings function', () {
      ...
      expect(content.toLowerCase().contains('function(apply_standard_settings'),
          isTrue,
          reason:
              'apply_standard_settings function must be defined in windows/CMakeLists.txt');
    });
    ...
    test('Windows flutter_window.cpp exists', () {
      ...
      expect(flutterWindowFile.existsSync(), isTrue,
          reason:
              'windows/runner/flutter_window.cpp must exist for Windows builds');
    });
  });
}
